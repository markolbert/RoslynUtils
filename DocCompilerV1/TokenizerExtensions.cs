...
namespace J4JSoftware.DocCompiler
{
    ...
    {
        public static TokenType[] ContainerTypeTokens { get; } =
        {
        ...
        public static bool IsCommentType( this Token token ) =>
            token.Type switch
            {
                TokenType.SingleLineComment => true,
                TokenType.MultiLineComment => true,
                TokenType.XmlComment => true,
                _ => false
            };
        ...
        public static bool HasTokenType( this TokenCollection tokenCollection, TokenType type ) =>
            tokenCollection.Tokens.Any( t => t.Type == type );

        public static AccessQualifier GetAccessibility( this TokenCollection tokenCollection )
        {
