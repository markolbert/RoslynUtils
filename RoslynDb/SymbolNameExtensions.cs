    ...
    public static class SymbolNameExtensions
    {
        ...
        private static string GetNamedTypeUniqueName( INamedTypeSymbol symbol )
        {
            ...
            if( symbol.IsTupleType )
            {
                ...
                foreach( var ctName in containingTypeNames ) sb.Append( $".{ctName}" );
            }
            else
            {
                sb.Append( symbol.ToDisplayString( UniqueGenericFormat ) );
            }
        ...
        private static SymbolDisplayFormat BasicFormat { get; } = new(
        ...
        private static SymbolDisplayFormat UniqueGenericFormat { get; } = new(
            SymbolDisplayGlobalNamespaceStyle.Omitted,
            SymbolDisplayTypeQualificationStyle.NameAndContainingTypesAndNamespaces,
